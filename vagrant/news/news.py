...
def check_for_output_file():
  ...
  if output_file.is_file():
    ...
    new_file.close()
    print("Text file 'output.txt' created. Please open this file once script has finished running. \n")
    run_db_queries()

def run_db_queries():
  print("Running database queries. This may take a moment... \n")
  queries = {
    "a - articles": {"question": "What are the most popular three articles of all time?", "results": get_articles()},
    "b - authors": {"question": "Who are the most popular article authors of all time?", "results": get_authors()},
    "c - errors": {"question": "On which days did more than 1 percent of requests lead to errors?", "results": get_errors()},
  }
